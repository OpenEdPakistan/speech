...
## Why?
_**Custom Development:**_ Developers typically write a Windows Forms or Console Application using C# to call the Microsoft Cognitive Services Speech API to generate audio utterances for their applications; refer to code in the Samples-Http folder [here](https://github.com/Microsoft/Cognitive-Speech-TTS)
## What?
